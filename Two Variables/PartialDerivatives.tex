...
\begin{enumerate}[leftmargin=*]
    ...
    \item Determine the \textbf{rate} at which the patient’s body surface area is changing with respect to a 1 pound increase in weight with the height being held constant. \vspace*{\stretch{1}}  
    \item Determine the \textbf{rate} at which the patient’s body surface area is changing with respect to a 1 inch increase in height with the weight being held constant.  \vspace*{\stretch{1}}  
    \end{enumerate}
    \begin{sol}
    \renewcommand{\labelenumi}{\textbf{(\alph{enumi})}}
    \begin{enumerate}[leftmargin=*]
